// app/api/final-assy-get-results.ts
...
export async function GET(request: NextRequest) {
  try {
    ...
    // ✅ PERBAIKAN: Query ke checklist_results (BUKAN checklist_signatures)
    const [results] = await pool.execute(
      `SELECT date_key, item_id, shift, status, ng_description, ng_department, submitted_at
